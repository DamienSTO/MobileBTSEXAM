...
class GestionUserActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        boutonHost.setOnClickListener { navigateTo(GestionHostActivity::class.java) }
        boutonPlus.setOnClickListener { navigateTo(AddUserActivity::class.java)}
        ...
        fetchUsers("http://192.168.19.1/toDoList/api/admin/student.php", token)
    }
    ...
    private fun onDeleteUser(userId: Int) {
        val url = "http://192.168.19.1/toDoList/api/admin/student-delete.php"
