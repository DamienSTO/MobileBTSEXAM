...
class HostActivity : AppCompatActivity() {
    ...
    private fun saveUserDetails() {
        ...
        if (username.isNotEmpty()) {
            editTeacherName(userId, username)
        }

        if (newPassword.isNotEmpty() && newPassword == confirmPassword) {
            changeTeacherPassword(userId, newPassword, adminPassword)
    ...
    private fun editTeacherName(userId: Int, username: String) {
        val url = "http://192.168.19.1/toDoList/api/admin/teacher-edit.php"
    ...
    private fun changeTeacherPassword(userId: Int, newPassword: String, adminPassword: String) {
        val url = "http://192.168.19.1/toDoList/api/admin/teacher-change.php"
